...
This file is the quick-reference operating contract for rcgen-kotlin. The longer
...
rcgen-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`rcgen`](https://crates.io/crates/rcgen). Upstream Rust is the behavioral oracle while the

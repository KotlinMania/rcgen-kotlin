...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Rcgen.swiftmodule/`
...
//      `import Rcgen` above would fail at compile time.
//
//   2. The static archive `libRcgen.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Rcgen" }` and
//      `flattenPackage = "io.github.kotlinmania.rcgen"` configuration in
...
final class RcgenExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Rcgen swift module imported cleanly")
    }
}

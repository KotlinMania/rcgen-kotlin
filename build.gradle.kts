...
kotlin {
    ...
    val xcf = XCFramework("Rcgen")

    macosArm64 {
        binaries.framework { baseName = "Rcgen"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Rcgen"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Rcgen"
        flattenPackage = "io.github.kotlinmania.rcgen"
    }

    android {
        namespace = "io.github.kotlinmania.rcgen"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "rcgen-kotlin", version.toString())

    pom {
        name.set("rcgen-kotlin")
        description.set("Kotlin Multiplatform port of rustls/rcgen - Rust X.509 certificate generator")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/rcgen-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/rcgen-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/rcgen-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/rcgen-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleRcgenXCFramework",
    "assembleRcgenDebugXCFramework",
    "assembleRcgenReleaseXCFramework",
    "assembleDebugIosFatFrameworkForRcgenXCFramework",
    "assembleReleaseIosFatFrameworkForRcgenXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForRcgenXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForRcgenXCFramework",
    "assembleDebugMacosFatFrameworkForRcgenXCFramework",
    "assembleReleaseMacosFatFrameworkForRcgenXCFramework",
    "assembleDebugTvosFatFrameworkForRcgenXCFramework",
    "assembleReleaseTvosFatFrameworkForRcgenXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForRcgenXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForRcgenXCFramework",
    "assembleDebugWatchosFatFrameworkForRcgenXCFramework",
    "assembleReleaseWatchosFatFrameworkForRcgenXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForRcgenXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForRcgenXCFramework",
